    ...
    public partial class RandomizedItems
    {
        public static RandomizedObjectList weapons = new RandomizedObjectList()
        {
            ...
            List = new List<RandomizedObjectDetails>()
            {
                ...
                new RandomizedObjectDetails{FancyName = "Magnum", Name = "magnum", Path = @"objects\weapons\pistol\magnum\magnum", AmmoMag = 8, AmmoTotal = 32, CompatibleEnemies = characters, Faction = Faction.Human, Weight = 20, CopyPropertiesFrom = @"objects\weapons\pistol\automag\automag"},
                new RandomizedObjectDetails{FancyName = "Automag", Name = "automag", Path = @"objects\weapons\pistol\automag\automag", AmmoMag = 12, AmmoTotal = 36, CompatibleEnemies = characters, Faction = Faction.Human, Weight = 20},
                ...
                new RandomizedObjectDetails{FancyName = "Plasma Rifle Red", Name = "plasma_rifle_red", Path = @"objects\weapons\rifle\plasma_rifle_red\plasma_rifle_red", CompatibleEnemies = characters, Faction = Faction.Covenant, Weight = 20},
                ...
                new RandomizedObjectDetails{FancyName = "SMG", Name = "smg", Path = @"objects\weapons\rifle\smg\smg", AmmoMag = 60, AmmoTotal = 180, CompatibleEnemies = characters, Faction = Faction.Human, Weight = 20, CopyPropertiesFrom = @"objects\weapons\rifle\smg_silenced\smg_silenced"},
                new RandomizedObjectDetails{FancyName = "SMG Silenced", Name = "smg_silenced", Path = @"objects\weapons\rifle\smg_silenced\smg_silenced", AmmoMag = 48, AmmoTotal = 144, CompatibleEnemies = characters, Faction = Faction.Human, Weight = 20},
                ...
                new RandomizedObjectDetails{FancyName = "Golf Club", Name = "golf_club", Path = @"objects\levels\dlc\shared\golf_club\golf_club", CompatibleEnemies = characters.FilterName("brute"), Weight = 1, CopyPropertiesFrom = @"objects\weapons\melee\gravity_hammer\gravity_hammer"},
